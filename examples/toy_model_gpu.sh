#!/bin/bash
#SBATCH --job-name=toy_model         # nom du job
...
#SBATCH --output=toy_model%j.out     # nom du fichier de sortie
#SBATCH --error=toy_model%j.err      # nom du fichier d'erreur (ici commun avec la sortie)
...
srun --unbuffered --mpi=pmi2 -o log_%t.txt /gpfslocalsup/pub/idrtools/bind_gpu.sh  python -u toy_model_gpu.py --model_dir=model_dir
